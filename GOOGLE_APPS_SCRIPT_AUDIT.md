...
| NETYR Donor and Contact Administration | Container-bound to institutional donor workbook | Administrative workbook menu, Contact ID linkage, recognition checkbox guidance, and donor-entry workflow | Inherited from bound project; separately authorized by the managed owner | Bound document context              | No website deployment required                                   | Copied with workbook; no managed-account installable trigger present |
...
- One-minute cache, privacy-safe internal diagnostics, and explicit unavailable
  response.
