...
| `Website Sponsors` Google Sheet tab   | Approved active sponsor names                           | Reached only through the isolated public Apps Script feed                      |
...
- The Sponsors endpoint reads only `Website Sponsors` and returns only approved
  active sponsor names.
