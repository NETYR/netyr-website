...
| High     | GitHub organization      | Add a second NETYR-controlled organization owner; `main` protection is enabled                                                                                                                    | No second authorized account exists in the current organization                                                                              | One-account lockout risk                                               |
